...
class tutorial_gr_satellites(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "gr_satellites_simple")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("gr_satellites_simple")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tutorial_gr_satellites")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/daniel-arod/Documentos/Semillero/SDR/2021-05-11_charla_sdr_flisol_ec/aausat_4.wav', True)
...
def main(top_block_cls=tutorial_gr_satellites, options=None):
