...
class gr_satellites_simple(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "gr_satellites_simple")
...
def main(top_block_cls=gr_satellites_simple, options=None):
